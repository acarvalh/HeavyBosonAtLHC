...
filename='results/ATLAS_VV_JJ_BulkWW_ourfit_Fudge'
...
fudgeWW=[0.513282, 0.553725, 0.609789, 0.637297, 0.642589, 0.626628, 0.610983, 0.601232, 0.560182, 0.538367, 0.557967]

for j in range(0,11,1): 
    procname = "BulkWW"+str(mass[j])
    model.scale_predictions(fudgeWW[j],procname=procname,obsname='ATLAS_VV_JJ')#The fudge factor                                                                 
...
# ../theta/utils2/theta-auto.py analysis_ATLAS_BulkWW_JJ_ourfit_fudge.py