...
filename='results/CMS_ATLAS_VV_lvJ_llJ_ZZ_WW_ourfit_r' +str(rr)
...
for j in range(0,16,1): 
    ...
    #    # CMS syst  llJ WZ
    # shape summed quadratically 
    model.scale_predictions(rzz,procname=procnamezz,obsname='CMS_ZVmmJ_HP')#The fudge factor    
    model.scale_predictions(rzz,procname=procnamezz,obsname='CMS_ZVmmJ_LP')#The fudge factor    
    model.scale_predictions(rzz,procname=procnamezz,obsname='CMS_ZVeeJ_HP')#The fudge factor    
    model.scale_predictions(rzz,procname=procnamezz,obsname='CMS_ZVeeJ_LP')#The fudge factor 
    #
    ...
    if j<11 :
        ...
        model.scale_predictions(rzz,procname=procnamezz,obsname='ATLAS_ZVllJ_HR')#The fudge factor   
...
fff.close()
print rr
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_ZZ_WW_lvJ_llJ_ourfit.py