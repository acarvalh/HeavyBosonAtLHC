...
filename='results/CMS_ATLAS_VV_JJ_BulkZZ_ourfit_Fudge'
...
for j in range(0,11,1): 
    ...
    model.scale_predictions(fudgeZZ[j]*1.1,procname=procname,obsname='ATLAS_VV_JJ')#The fudge factor          
...
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_BulkZZ_JJ_ourfit_fudge.py 