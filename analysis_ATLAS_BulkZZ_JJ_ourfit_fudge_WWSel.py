...
filename='results/ATLAS_VV_JJ_BulkZZ_ourfit_Fudge_WWSel'
...
#expected.write_txt('results/ATLAS_VV_JJ_BulkZZ_ourfit_Fudge_expected.txt')
#observed.write_txt('results/ATLAS_VV_JJ_BulkZZ_ourfit_Fudge_observed.txt')
...
fudgeBulkZZ=[0.55619, 0.565121, 0.561593, 0.569191, 0.564982, 0.528031, 0.488941,0.488903, 0.40283, 0.401571, 0.387373]

for j in range(0,11,1): 
    procname = "BulkZZ"+str(mass[j])
    model.scale_predictions(fudgeBulkZZ[j]*0.4172,procname=procname,obsname='ATLAS_VV_JJ')#The fudge factor                                                                 
...
#zlevel.write_txt('CMS_ATLAS_VV_JJ_BulkZZ_ourfit_noFudge_zlevel.txt')
...
# ../theta/utils2/theta-auto.py analysis_ATLAS_BulkZZ_JJ_ourfit_fudge_WWSel.py