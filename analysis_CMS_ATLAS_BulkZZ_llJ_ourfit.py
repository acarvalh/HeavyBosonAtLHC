...
expected.write_txt('results/CMS_ATLAS_VV_llJ_BulkZZ_ourfit_expected.txt')
observed.write_txt('results/CMS_ATLAS_VV_llJ_BulkZZ_ourfit_observed.txt')
#zlevel.write_txt('CMS_ATLAS_VV_JJ_WZ_ourfit_noFudge_zlevel.txt')

current = 1
with open('results/CMS_ATLAS_VV_llJ_BulkZZ_ourfit_zlevel.txt', 'w') as fff:
    while current < 16:
        masse = mass[current]
