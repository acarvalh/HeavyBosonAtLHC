#model = build_model_from_rootfile(["ATLAS_VV_JJ/ATLAS_VV_JJ_ZZ_corrected.root","ATLAS_VV_JJ/ATLAS_ZZ_JJ_1fb_SignalRS.root","ATLAS_VV_JJ/ATLAS_ZZ_JJ_1fb_Signal_sys_noJER.root"])

model = build_model_from_rootfile(["ATLAS_VV_JJ/ATLAS_ZZJJ__DATA_noZZname_publicBackground.root",
...
expected.write_txt('results/ATLAS_VV_JJ_BulkZZ_public_expected.txt')
observed.write_txt('results/ATLAS_VV_JJ_BulkZZ_public_observed.txt')

current = 1
with open('results/ATLAS_VV_JJ_BulkZZ_public_zlevel.txt', 'w') as fff:
...
# ../theta/utils2/theta-auto.py analysis_ATLAS_BulkZZ_JJ_public.py