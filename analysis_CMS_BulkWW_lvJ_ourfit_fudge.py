...
#filename='results/CMS_VV_lvJ_ZpWW_ourfit_Fudge'
filename='results/CMS_VV_lvJ_ZpWW_ourfit_Fudge_wide'
...
# ../theta/utils2/theta-auto.py analysis_CMS_BulkWW_lvJ_ourfit_fudge.py