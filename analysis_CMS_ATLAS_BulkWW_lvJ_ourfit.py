...
#    model.scale_predictions(fudgeWW[j],procname=procnameC,obsname='CMS_VV_lnuj_MUHP')#The fudge factor    
#   model.scale_predictions(fudgeWW[j],procname=procnameC,obsname='CMS_VV_lnuj_MUHP')#The fudge factor    
...
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_BulkWW_lvJ_ourfit.py