model = build_model_from_rootfile(["CMS_VV_lnuJ/CMS_WZ_ELEHP_1fb_NarrowSignal.root",
                                   ...
                                   #"CMS_VV_JJ/CMS_VV_jj_WZsemi_1fb.root"
                                   ])
# 
# print model
...
fudgeWZJJ=[0.513282, 0.553725, 0.609789, 0.637297, 0.642589, 0.626628, 0.610983, 0.601232, 0.560182, 0.538367, 0.557967]

rangenorm = 3.0

model.set_signal_processes("WZ*")

filename='results/CMS_ATLAS_VV_lvJ_llJ_JJ_WZ_ourfit'
...
with open(z22, 'w') as fff:
        ...
        fff.write( str(nllLik) )
fff.close()
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_WZ_lvJ_llJ_JJ_ourfit.py