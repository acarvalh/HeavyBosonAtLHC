...
filename='results/CMS_ATLAS_WW_WZ_JJ_WZSel_r'+str(rr)
...
for j in range(0,11,1): 
  ...
  # ATLAS syst
  Arww=fudgeWW[j]*rww*0.8382*1.1
  Arzz=fudgeWZ[j]*rzz*1.1
...
# less r  2.5 ; midle r 3.5 ; high r 5.5
#rangenorm=3.5
...
print p1sigma , ", " , p2sigma , ", " , p3sigma , ", " , p4sigma , ", "  

report.write_html('htmlout')

# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_WW_WZ_JJ_SigComp_WZwindow.py