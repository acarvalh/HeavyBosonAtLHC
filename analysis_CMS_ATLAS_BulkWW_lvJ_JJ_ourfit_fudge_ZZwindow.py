...
zzsel='_ZZSel'
if fudge :
    expfile = filename+fudgeLabel+zzsel+'_expected.txt'
    obsfile = filename+fudgeLabel+zzsel+'_observed.txt'
    zfile = filename+fudgeLabel+zzsel+'_zlevel.txt'
else :
    expfile = filename+zzsel+'_expected.txt'
    obsfile = filename+zzsel+'_observed.txt'
    zfile = filename+zzsel+'_zlevel.txt'
...
for j in range(0,16,1): 
    ...
    if fudge :
        ...
        if j>4 :
            model.scale_predictions(fudgeWWJJATLAS[j]*narrow*window,procname=procname,obsname='ATLAS_VV_JJ') 
    elif j>4 :
        model.scale_predictions(narrow*window,procname=procname,obsname='ATLAS_VV_JJ') 
    ######################################################################################################  
    # SEMI
    # ATLAS syst                        
...
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_BulkWW_lvJ_JJ_ourfit_fudge_ZZwindow.py