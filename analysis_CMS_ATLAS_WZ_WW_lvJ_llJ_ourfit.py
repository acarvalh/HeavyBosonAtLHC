...
filename='results/CMS_ATLAS_VV_lvJ_llJ_WZ_WW_ourfit_r' +str(rr)
...
for j in range(0,16,1): 
    ...
    model.scale_predictions(rzz,procname=procname,obsname='ATLAS_WVlnJ_MR')
    ...
    #
    model.scale_predictions(rww,procname=procnameww,obsname='ATLAS_WVlnJ_MR')
    ...
    #    # CMS syst lvJ WZ
    model.scale_predictions(rzz,procname=procname,obsname='CMS_VV_lnuj_MUHP')#The fudge factor    
    model.scale_predictions(rzz,procname=procname,obsname='CMS_VV_lnuj_MULP')#The fudge factor    
    model.scale_predictions(rzz,procname=procname,obsname='CMS_VV_lnuj_ELEHP')#The fudge factor    
    model.scale_predictions(rzz,procname=procname,obsname='CMS_VV_lnuj_ELELP')#The fudge factor    
    ...
    #    # CMS syst  llJ WZ
    # shape summed quadratically 
    model.scale_predictions(rzz,procname=procname2,obsname='CMS_ZVmmJ_HP')#The fudge factor    
    model.scale_predictions(rzz,procname=procname2,obsname='CMS_ZVmmJ_LP')#The fudge factor    
    model.scale_predictions(rzz,procname=procname2,obsname='CMS_ZVeeJ_HP')#The fudge factor    
    model.scale_predictions(rzz,procname=procname2,obsname='CMS_ZVeeJ_LP')#The fudge factor 
    #
    ...
    if j<11 :
        #    # ATLAS syst  llJ WZ
        model.scale_predictions(rzz,procname=procname,obsname='ATLAS_ZVllJ_MR')#The fudge factor                 
        model.scale_predictions(rzz,procname=procname,obsname='ATLAS_ZVllJ_HR')#The fudge factor   
...
fff.close()
print rr
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_WZ_WW_lvJ_llJ_ourfit.py