...
filename='results/ATLAS_VV_JJ_BulkWW_ourfit_WZSel'
...
for j in range(0,11,1): 
    ...
    model.scale_predictions(0.8382,procname=procname,obsname='ATLAS_VV_JJ')#The fudge factor                                                                 
...
# ../theta/utils2/theta-auto.py analysis_ATLAS_BulkWW_JJ_ourfit_WZSel.py