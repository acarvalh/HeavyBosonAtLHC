...
filename='results/ATLAS_VV_JJ_WZ_ourfit_WWSel'
...
for j in range(0,11,1): 
    ...
    model.scale_predictions(0.6459,procname=procname,obsname='ATLAS_VV_JJ')#The fudge factor                                                                 
...
# ../theta/utils2/theta-auto.py analysis_ATLAS_WZ_JJ_WWwindow.py