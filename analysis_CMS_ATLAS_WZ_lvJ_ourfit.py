model = build_model_from_rootfile(["CMS_VV_lnuJ/CMS_WZ_ELEHP_1fb_Signal.root",
                                   "CMS_VV_lnuJ/CMS_WZ_ELELP_1fb_Signal.root",
                                   "CMS_VV_lnuJ/CMS_WZ_MUHP_1fb_Signal.root",
                                   "CMS_VV_lnuJ/CMS_WZ_MULP_1fb_Signal.root",
                                   #
...
filename='results/CMS_ATLAS_VV_lvJ_WZ_ourfit'
...
with open(zfile, 'w') as fff:
    while current < len(zlevel):
        ...
        current += 1
fff.close()
# ../theta/utils2/theta-auto.py analysis_CMS_ATLAS_WZ_lvJ_ourfit.py