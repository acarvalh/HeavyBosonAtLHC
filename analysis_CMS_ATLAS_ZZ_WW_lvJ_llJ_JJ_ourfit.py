...
fudgeZZJJ=[1,1,1,1,1,0.531894, 0.555135, 0.566784, 0.601672, 0.630537, 0.618207, 0.596984, 0.616378, 0.519181, 0.520399, 0.495976]

fudgeWWJJ=[1,1,1,1,1,0.516994, 0.557296, 0.607179, 0.630566, 0.636335, 0.622595, 0.610246, 0.605146, 0.568741, 0.551866, 0.577838]
 
totWW= rww*0.7027

filename='results/CMS_ATLAS_VV_lvJ_llJ_JJ_ZZ_WW_ourfit_r' +str(rr)
...
for j in range(0,16,1): 
    ...
    if j<11 :
        ...
        model.add_lognormal_uncertainty("normalisation_VVllJ_atlas",0.1,procname=procnamezz,obsname='ATLAS_ZVllJ_HR')
        model.add_lognormal_uncertainty("lumi_atlas",0.028,procname=procnamezz,obsname='ATLAS_ZVllJ_MR')
        model.add_lognormal_uncertainty("lumi_atlas",0.028,procname=procnamezz,obsname='ATLAS_ZVllJ_MR')

    if j>4 :
        #model.scale_predictions(fudgeZZJJ[j]*rzz,procname=procnamezz,obsname='ATLAS_VV_JJ') 
