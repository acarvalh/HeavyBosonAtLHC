model = build_model_from_rootfile(["CMS_VV_JJ/CMS_VV_jj_data.root","CMS_VV_JJ/CMS_VV_jj_BulkZZ_1fb.root"])
...
filename='results/CMS_VV_JJ_BulkZZ_ourfit'
...
#  ../theta/utils2/theta-auto.py analysis_CMS_BulkZZ_JJ_ourfit.py